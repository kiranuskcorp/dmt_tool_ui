		...
		<div class="row">
			...
			<div class="row">
				<p>
					...
					<a href="./Excels/technologyexcel.php" class="btn btn-default btn-lg " role="button" ><i class="fa fa-file-excel-o"></i></a>
				</p>
		              ...
		              <?php 
					   ...
					   foreach ($data as $row) {
							   ...
							   //echo '<td>'. $row['description'] . '</td>';
							   	...
							   	echo '<a href="?content=3&id='.$row['id'].'"><i class="icon-edit"></i></a>';
							   	echo '<a href="?content=1&id='.$row['id'].'"  onclick="return confirm(\'Are you sure you want to delete?\')" ><i class="icon-trash"></i></a>';//'?content=16&id='.$row['id'].'
							   	echo '</td>';
							   	echo '</tr>';
					   }
