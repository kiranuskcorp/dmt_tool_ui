...
<body>
    <div class="container">
    			...
    			<div class="span10 offset1">
	    			...
	    			<form class="form-horizontal" action="./question/update.php?id=<?php echo $id?>" method="post">
					...
					<div class="controls">
					  ...
					  <div class="control-group"> 
					    ...
					    <div class="controls">
					      	<input name="question" type="text"  placeholder="question" value="<?php echo !empty($question)?$question:'';?>" required>
					  ...
					  <div class="control-group"> 
					    ...
					    <div class="controls">
					      	<input name="answers" type="text"  placeholder="answers" value="<?php echo !empty($answers)?$answers:'';?>" required>
