...
class SqlConstants {
	static $allSelect = array( 
			...
			"contactSelectById" => "SELECT * FROM contact where id = ?",
			...
			"questionSelect" => "SELECT q.*, i.interviewer as interview_name FROM question q, interview i WHERE q.interview_id= i.id",
	...
	static $totalConstants = array( 
			"todoConstants" => "In Progress,Completed",
			...
			"statusConstants" => "In Progress,Cleared,Cancelled,Not Started,Closed,Payment Pending",
